...
export default async function CakeDetailPage({ params }: { params: Promise<{ slug: string | string[] }> }) {
  ...
  const { name, price, priceUnit, description, additionalDetails, imageUrl, dropdownDescription, dropdownAllergens, dropdownStorage, dropdownTransport } = product
